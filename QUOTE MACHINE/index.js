...
function App(){
    ...
    return(
        <div className="wrapper" style={{backgroundColor: color, minHeight:"100vh"}}>
        <div id="quote-box" className="container pt-5 text-center" >
        ...
        <div className="jumbotron">
            <div className="card">
                ...
                <div className="card-body">
                    ...
                    <div className="row">
                        <button onClick={getNewQuote} id="new-quote" className=" btn btn-primary ml-3">New Quote</button>
                        <a id="tweet-quote" 
                        href= {
